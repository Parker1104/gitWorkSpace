...
<div id="showsearch" class="list" style="display: none">
    <form action="${basePath}/wristStrapHairpinStatisticsController/list" id="searchMemberCardForm" method="post">
			<div class="list">
				<ul>
					<li>操作员：<input name="accountname" id="accountname" type="text" /></li>
...
function formToJson(id){//把form表单的所有数据变成json对象
    ...
    $(document).ready(function(){
        ...
        $("#datatable").jqGrid({
            url:'${basePath}/wristStrapIsMissingStatisticsController/list',
            datatype: "json",
            mtype: "POST",
            ...
            footerrow:true, 
            shrinkToFit:true,
            colNames:['','操作员','挂失卡数量','补办卡数量','','丢失率','','补卡金额','时间','备注'],
            colModel:[
                ...
                {name:"lossCardCount",index:"lossCardCount",align:'center',width:200,sortable:false},
                {name:"replaceCardCount",index:"replaceCardCount",align:'center',width:200,sortable:false,formatter:function(el,options,rowData){
                    var t = rowData.lossCardCount-rowData.replaceCardCount
                    return t;
                }},
                {name:"sendcardcount",index:"sendcardcount",align:'center',width:200,sortable:false,hidden:true},
                {name:"notcollectcount",index:'notcollectcount',align:'center',width:200,sortable:false,formatter:function(el,options,rowData){
                    var a = rowData.lossCardCount/rowData.sendcardcount;
                ...
                {name:"money",index:'money',align:'center',width:200,sortable:false,hidden:true},
                {name:"",index:'',align:'center',width:200,sortable:false,formatter:function(el,options,rowData){
                    var t = (rowData.lossCardCount-rowData.replaceCardCount)*rowData.money
                    return t;
                }},
