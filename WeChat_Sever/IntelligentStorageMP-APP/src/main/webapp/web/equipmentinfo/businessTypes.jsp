...
<body>
	...
	<div class="content">
	 ...
	 <div id="showadd" style="display: none;">
		<form id="modifyCode" action="${pageContext.request.contextPath}/businessControlleres/addNew"
			method="post">
	...
	<div id="showupdate" class="list" style="display: none;">
		<form id="modifyCode2" action="${pageContext.request.contextPath}/businessControlleres/updateNew"
			method="post">
			<table width="618" height="200" class="list" border="0"
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#datatable").jqGrid({
				url : '${pageContext.request.contextPath}/businessControlleres/list',
				datatype : "json",
				mtype : "POST",
		...
		var openDialog4Updating = function(row) { // (6) 接受选中行的id为参数  
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/businessControlleres/updateAll?code="
								+ col.businesscode,
						success : function(msg) {
		...
		var openDialog4Deleting = function(row) { // (8) 接受选中行的id为参数  
			...
			var d = dialog({
				...
				ok : function() {
					...
					$.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/businessControlleres/delete?code="
								+ col.businesscode,
						success : function(msg) {
							showMsg(eval("(" + msg + ")").msg);
