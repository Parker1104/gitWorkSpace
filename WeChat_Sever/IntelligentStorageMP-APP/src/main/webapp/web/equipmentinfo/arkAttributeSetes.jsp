...
<body>
	...
	<div id="showsearch" class="list" style="display: none">
		<form id="searchMemberCardForm"
			action="${pageContext.request.contextPath}/terminalControlleres/list" method="get">
			<div class="list">
				<ul>
	...
	<div id="showadd" class="list" style="display: none">
		<form id="modifyCode" action="${pageContext.request.contextPath}/terminalControlleres/add"
			method="post">
			<ul>
	...
	<script type="text/javascript">
				...
				.ready(
						function() {
							...
							$("#datatable")
									.jqGrid(
											{
											    url : '${pageContext.request.contextPath}/terminalControlleres/list?',
												datatype : "json",
												mtype : "POST",
					...
					if (ids.length > 0) {
						for (var i = 0; i < ids.length; i++) {
							...
							$
									.ajax({
										type : "POST",
										url : "${pageContext.request.contextPath}/terminalControlleres/delete?id="
												+ col.terminalid,
										success : function(msg) {
											d.close();
											showMsg(eval("(" + msg + ")").msg);
		...
		function selectid() {
			...
			if (terminalid == "") {
				...
				$.ajax({
					type : "POST",
					url : "${pageContext.request.contextPath}/terminalControlleres/select",
					data : {
