									...
									.ajax({
										...
										success : function(msg) {
											if (msg.length > 0) {
												...
												html += "</select'>"
												html += "<input type='submit' value='开2箱' onclick='outOfTeWay(0)' style='width:45px; background-color: #74A3DC;margin-left: 15px;border: none;border-radius: 3px;'>"
												html += "<input type='submit' value='锁定' onclick='lockBoxTeWay()'  style='width:45px; background-color: #74A3DC;margin-left: 15px;border: none;border-radius: 3px;'>"
												html += "<input type='submit' value='清箱' onclick='clearBoxTeWay()'  style='width:45px; background-color: #74A3DC;margin-left: 15px;border: none;border-radius: 3px;'>"
												html += "<input type='submit' value='解锁' onclick='unlockBoxTeWay()' style='width:45px; background-color: #74A3DC;margin-left: 15px; border: none;border-radius: 3px;'></li></ul>"
				...
				<form id="OutOfTheFrom" action="">
					<ul>
					  ...
					  — 截止箱编号：<input type="text" id="kaixiangs" style="width: 88px;height: 24px" maxlength="60" onkeyup="this.value=this.value.replace(/\D/g,'')">  </li> -->
						<li>起始1箱编号：<select name="kaixiang" id="kaixiang"
							style="width: 88px; height: 24px">
								<option value="" selected="selected">请选择</option>
						</select> - 截止1箱编号：<select name="kaixiangs" id="kaixiangs"
							style="width: 88px; height: 24px">
								<option value="" selected="selected">请选择</option>
						</select>
						</li>
