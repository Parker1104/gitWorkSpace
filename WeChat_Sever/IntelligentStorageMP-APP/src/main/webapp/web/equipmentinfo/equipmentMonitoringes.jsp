	...
	<script type="text/javascript">
		...
		function openBox(index) {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/opendirtyBox.do",
						data : {
							terminalid : terminallist[index].terminalid,
							"boxid" : terminallist[index].boxid
						},
		...
		function openArk(index) {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/OpenAllBox.do",
						data : {
							terminalid : terminallist[index].terminalid,
							"boxid" : 0
						},
		...
		function openLeisure(index) {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/openLeisureBox.do",
						data : {
							terminalid : terminallist[index].terminalid,
							"boxid" : 0
						},
		...
		function openOverdueBox(index) {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/openOverdueBox.do",
						data : {
							terminalid : terminallist[index].terminalid,
							"boxid" : 0
						},
		...
		function openUsedBox(index) {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/openUsedBox.do",
						data : {
							terminalid : terminallist[index].terminalid,
							"boxid" : 0
						},
		...
		function opendirtyBoxIdByAreaCode() {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/selectAllFreeBox.do",
						data : {
		...
		function queryTankno(terminalid) {
			$
					.ajax({
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/queryTankno.do",
						data : {
		...
		function selectAllBox() {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/selsctTerminalEntity.do",
						data : {
							areacode : treeNode.id
						},
						async : false,
		...
		function zTreeOnClick(event, treeId, treeNode) {
			...
			$
					.ajax({
						type : "post",
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/selsctTerminalEntityOrBox.do",
						data : {
							areacode : treeNode.id
						},
						dataType : 'json',
													...
													.ajax({
														...
														success : function(msg) {
															if (msg.length > 0) {
																...
																$
																		.ajax({
																			url : "${pageContext.request.contextPath}/equipmentMonitoringes/selsctBeBoxCount.do",
																			type : "post",
																			dataType : 'json',
																			data : {
																				areacode : treeNode.id
		...
		function tankNo() {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/selsctallBox.do?number=Math.random()",
						data : {
							tankNo : options.val()
						},
						success : function(msg) {
		...
		function selsctBoxState(terminalid) {
			$
					.ajax({
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/selsctBoxState.do",
						type : "post",
						dataType : 'json',
						data : {
							terminalid : terminalid
		...
		function selsctTimeoutBox(terminalid) {
			$
					.ajax({
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/selsctTimeoutBox.do",
						type : "post",
						dataType : 'json',
						data : {
							terminalid : terminalid
		...
		function OpensBox() {
			$
					.ajax({
						url : "http://192.168.8.46:8080/IntelligentStorageMP-APP/equipmentMonitoringes/???",
						type : "post",
						dataType : 'json',
						data : {
							//APP存  取要传的参数 
		...
		function outOfTeWayopen(terId, boxid, EndBoxNo, count) {
			$
					.ajax({
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/openBox.do",
						data : {
							terId : terId,
							startBoxNo : boxid,
							EndBoxNo : EndBoxNo
			...
			var dialogCode = dialog({
				...
				ok : function() {
					...
					if (lockBox == "" || lockBox == null) {
						...
						$
								.ajax({
									url : "${pageContext.request.contextPath}/equipmentMonitoringes/lockBox.do",
									data : {
										terId : terId,
										lockBox : lockBox,
									},
			...
			var dialogCode = dialog({
				...
				ok : function() {
					...
					if (unlockBox == "" || unlockBox == null) {
						...
						$
								.ajax({
									url : "${pageContext.request.contextPath}/equipmentMonitoringes/unlockBox.do",
									data : {
										terId : terId,
										unlockBox : unlockBox,
									},
		...
		function missBoxTeWay() {
			var dialogCode = dialog({
				...
				ok : function() {					
					$.ajax({
						url : "${pageContext.request.contextPath}/equipmentMonitoringes/missBox.do",
						data : {},
						success : function(msg) {
							showMsg(eval("(" + msg + ")").msg);							
						},
			...
			var dialogCode = dialog({
				...
				ok : function() {
					...
					if (clearBox == "" || clearBox == null) {
						...
						$
								.ajax({
									url : "${pageContext.request.contextPath}/equipmentMonitoringes/clearBox.do",
									data : {
										terId : terId,
										clearBox : clearBox,
									},
						...
						function() {
							$
									.ajax({
										...
										url : "${pageContext.request.contextPath}/equipmentMonitoringes/findAll.do",
										//data : {"ids": ids},
