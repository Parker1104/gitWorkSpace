                ...
                <div style="height: 100%; border: 1px solid #e6e6e6; overflow: hidden;">
                    <div class="dashboard-stats">
                        <div class="dashboard-stats-item" style="background-color: #578ebe;">
                            ...
                            <h2 class="m-top-none">${status}<span>个</span></h2>
                            <h5>待办未处理</h5>
                        </div>
                    </div>
                    <div class="dashboard-stats">
                    ...
                    <div class="dashboard-stats">
                        <div class="dashboard-stats-item" style="background-color: #4f5c65; margin-bottom: 0px;">
                            <h2 class="m-top-none">${tcount}<span>次</span></h2>
                            <h5>今日使用数</h5>
                            <div class="stat-icon">
                    ...
                    <div class="dashboard-stats">
                        <div class="dashboard-stats-item" style="background-color: #14aae4; margin-bottom: 0px;">
                            <h2 class="m-top-none">${ycount}<span>次</span></h2>
                            <h5>昨日使用数</h5>
                            <div class="stat-icon">
                    ...
                    <div class="dashboard-stats">
                        <div class="dashboard-stats-item" style="background-color: #f29503; /* margin-right: 0px; */ margin-bottom: 0px;">
                            <h2 class="m-top-none">${money}<span>元</span></h2>
                            <h5>昨日成交金额</h5>
                            <div class="stat-icon">
            ...
            <div style="float: left; width: 33.8%; margin-right: 0.8%;">
                <div style="height: 240px; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">创新企业党建思想政治工作</a><span class="time">2016-07-02</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">现代国有企业道德体系初构</a><span class="time">2016-06-18</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">国有企业文化问题根源及文化重塑任务分析</a><span class="time">2016-06-26</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">国有企业文化建设必须突出员工文化</a><span class="time">2016-04-20</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">加强企业公民建设 推进企业和谐发展</a><span class="time">2016-03-08</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">不断提升大庆精神 实现企业持续发展</a><span class="time">2016-02-22</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">科学发展作指导 人水和谐路更宽</a><span class="time">2016-02-15</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div style="float: left; width: 34.6%; margin-right: 0.8%;">
                <div style="height: 240px; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">【通知】新版员工守则，即日执行</a><span class="time">2016-07-21</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">【公告】OA办公使用指南</a><span class="time">2016-07-21</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">【公告】劳动节集体出游指南</a><span class="time">2016-07-21</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">【通知】2016年G20财长和央行行</a><span class="time">2016-07-21</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">【通知】2016年G20财长和央行行</a><span class="time">2016-07-21</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">【通知】品牌价值的最佳选择</a><span class="time">2016-07-21</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">【公告】采购商城全新升级自营业正品</a><span class="time">2016-07-21</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div style="float: right; width: 30%;">
                <div style="height: 240px; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">南京森鹿皮件服饰有限公司</a><span class="time">2016-07-21</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">曲靖市绿能燃气运输有限公司</a><span class="time">2016-07-20</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">青海航天信息有限公司</a><span class="time">2016-07-19</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">吉林省蔬菜花卉科学研究院</a><span class="time">2016-07-17</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">青海省广播电视信息网络股份有限公司</a><span class="time">2016-07-17</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">国营长空精密机械制造公司</a><span class="time">2016-07-13</span></li>
                                <li><a href="http://www.hzdongcheng.com" target="_blank">广东友元国土信息工程有限公司</a><span class="time">2016-07-12</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
